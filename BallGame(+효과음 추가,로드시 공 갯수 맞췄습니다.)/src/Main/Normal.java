...
public class Normal extends GameDifficult {
    private Random r = new Random();
    Normal(HUD hud, Handler handler,Game game){
    ...
    public void setEnenmy(){
        ...
        } else if (hud.getlevel() % 4 == 0 && hud.getlevel() < 20) {
        ...
        } else if(hud.getlevel() % 2 == 0 && hud.getlevel() > 20){
            handler.addObject(new ScoreItem(r.nextInt(Game.WIDTH - 20), r.nextInt(Game.HEIGHT - 45), ID.ScoreItem, handler, game.diff, hud));
        }
